...
public class JsonToPostgresNikeMale {
    ...
    public void importData() {
        try {
            ...
            InputStream inputStream = getClass().getClassLoader().getResourceAsStream("nike_products.json");
            if (inputStream == null) {
            ...
            log.info("Successfully imported all Nike items to PostgreSQL");

        } catch (Exception e) {
            log.error("Error importing Nike JSON data: ", e);
        }
    }
