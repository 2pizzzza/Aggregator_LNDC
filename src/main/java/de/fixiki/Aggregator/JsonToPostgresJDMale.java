...
//public class JsonToPostgresJDMale {
...
//            InputStream inputStream = getClass().getClassLoader().getResourceAsStream("jdsports_products.json");
//            if (inputStream == null) {
...
//                Optional<Shop> existingShop = shopRepository.findAll().stream().findFirst();
...
//            }
//            log.info("Successfully imported all items to PostgreSQL");
//        } catch (Exception e) {
